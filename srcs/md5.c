...
//padding, mandatory to make every message workable and different, same for sha 256 and whirlpool
...
//reverse the endian of the result and put it in buff
...
//implementation of the MD5 crypt hash algo
char *md5(char *str)
{
	//every round shift
	...
	//result of int(2^32 * sin(i + 1)) for i in range 0 to 63
